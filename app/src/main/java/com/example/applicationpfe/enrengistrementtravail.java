...
public class EnregistrementTravailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etLocalisation = findViewById(R.id.edit_localisation);
                ...
                enregistrementRef.child(travailId).setValue(travail)
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(EnregistrementTravailActivity.this, "Enregistrement de travail enregistré avec succès", Toast.LENGTH_SHORT).show();
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(EnregistrementTravailActivity.this, "Erreur lors de l'enregistrement du travail", Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
